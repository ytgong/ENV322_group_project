...
#BLUEdata
BLUEdata <- BLUEdata %>%
  select(dateTime, Nitrate_mgl, Flow_Inst)
...
write.csv(BLUEdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/BLUEdata.csv")
...
write.csv(BOWdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/BOWdata.csv")
...
write.csv(CALdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/CALdata.csv")
...
write.csv(CHASdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/CHASdata.csv")
...
write.csv(CRANEdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/CRANEdata.csv")
...
write.csv(DRAINdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/DRAINdata.csv")
...
write.csv(FANdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/FANdata.csv")
...
write.csv(FELLdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/FELLdata.csv")
...
write.csv(HOLdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/HOLdata.csv")
...
write.csv(HOMdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/HOMdata.csv")
...
write.csv(HUNdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/HUNdata.csv")
...
write.csv(ICHEdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/ICHEdata.csv")
...
write.csv(MADdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/MADdata.csv")
...
write.csv(MAINdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/MAINdata.csv")
...
write.csv(MANdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/MANdata.csv")
...
write.csv(RAINdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/RAINdata.csv")
...
write.csv(SANTAdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/SANTAdata.csv")
...
write.csv(TURKdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/TURKdata.csv")
...
write.csv(TURNdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/TURNdata.csv")
...
write.csv(WACdata, file = "/ENV322_group_project/Processed_Dataframes/Nitrate_Sites/WACdata.csv")
