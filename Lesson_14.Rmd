...
> different water paths(quickflow=overland,pipes, etc; baseflow=groundwater,soil) create different chemical signatures
...
>counterclockwise: [baseflow]>[quickflow]

Which direction do hysteresis loops go for flushing storms?

>clockwise: [quickflow]>[baseflow]

## Using dissolved oxygen to estimate metabolism

What is "ecosystem metabolism"?

>GPP: Gross Primary Productivity, creates more DO.
>ER: Ecosystem Respiration, uptakes DO.
