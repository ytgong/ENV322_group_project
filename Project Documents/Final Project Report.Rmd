...
```{r, echo = FALSE, message = FALSE, fig.cap="C-Q Plots of Chemostatic Sites",fig.height=5}
...
```{r, echo = FALSE, message = FALSE, fig.cap="C-Q Plots of Flushing Sites",fig.height=5}
...
```{r, echo = FALSE, message = FALSE, fig.cap="C-Q Plots of Diluting Sites",fig.height=5}
